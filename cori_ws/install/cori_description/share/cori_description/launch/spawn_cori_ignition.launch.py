...
def generate_launch_description():
    ...
    # Use package-local world file (this was moved to package during install)
    ...
    # Set Gazebo resource path to find package meshes
    gazebo_resource_path = SetEnvironmentVariable(
        name='GZ_SIM_RESOURCE_PATH',
        value=package_share_dir
    )
    ...
    try:
        ...
        # Fix package:// paths to absolute paths for Gazebo Ignition compatibility
        mesh_dir = os.path.join(package_share_dir, 'meshes')
        robot_desc = robot_desc.replace('package://cori_description/meshes', mesh_dir)
    ...
    return LaunchDescription([
        gazebo_resource_path,        # Set resource path FIRST
        gz_sim,
