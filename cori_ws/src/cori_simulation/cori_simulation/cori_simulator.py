...
try:
    from cori_core.database_manager import CORIDatabaseManager
except ImportError:
    # Fallback for direct execution
    import sys
    sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', 'cori_core'))
    from database_manager import CORIDatabaseManager
